...
void main()
{
    ...
    weight[0]  = abs(val[0]-val[7])<threshold ? 0.0180 : 0.0;
    weight[1]  = abs(val[1]-val[7])<threshold ? 0.0332 : 0.0;
    weight[2]  = abs(val[2]-val[7])<threshold ? 0.0547 : 0.0;
    weight[3]  = abs(val[3]-val[7])<threshold ? 0.0807 : 0.0;
    weight[4]  = abs(val[4]-val[7])<threshold ? 0.1065 : 0.0;
    weight[5]  = abs(val[5]-val[7])<threshold ? 0.1258 : 0.0;
    weight[6]  = abs(val[6]-val[7])<threshold ? 0.1330 : 0.0;
    weight[7]  = abs(val[7]-val[7])<threshold ? 0.1258 : 0.0;
    weight[8]  = abs(val[8]-val[7])<threshold ? 0.1065 : 0.0;
    weight[9]  = abs(val[9]-val[7])<threshold ? 0.0807 : 0.0;
    weight[10]  = abs(val[10]-val[7])<threshold ? 0.0547 : 0.0;
    weight[11]  = abs(val[11]-val[7])<threshold ? 0.0332 : 0.0;
    weight[12]  = abs(val[12]-val[7])<threshold ? 0.0180 : 0.0;
