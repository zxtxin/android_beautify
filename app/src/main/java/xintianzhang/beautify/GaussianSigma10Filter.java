 ...
 */
public class GaussianSigma10Filter extends FilterBase{
    ...
    private final int rawLumTexteureUniform;
    private final int alphaUniform;
    private final int whitenUniform;


    public GaussianSigma10Filter(OpenGLESSupervisor instance) {
        super(instance);
        fbo = glInstance.getFBO();
        program = glInstance.buildShaderProgram(R.raw.gaussian_vertex, R.raw.guassian_sigma10_fragment);
        ...
        rawLumTexteureUniform = GLES20.glGetUniformLocation(procedure_2, "rawLumTex");
        alphaUniform = GLES20.glGetUniformLocation(procedure_2, "alpha");
        whitenUniform = GLES20.glGetUniformLocation(procedure_2, "whiten");
    }
 ...
 //       GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, tex[0]);
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, size.width, size.height, 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, frameData);
        GLES20.glUniform1i(rawLumTexteureUniform, 1);
        ...
        GLES20.glUniform1i(whitenUniform,whiten);
